...
std::vector<GLint> triangeIndices = {0, 1, 2};
...
void triangleDisplay(glm::mat4 viewMatrix, glm::mat4 projectionMatrix) {
    ...
    modelMatrix = translate(modelMatrix, glm::vec3(0.0f, 0.0f, -2.0f));
    ...
    glDrawElements(GL_TRIANGLES, sizeof(triangeIndices) * sizeof(triangeIndices[0]), GL_UNSIGNED_INT, 0);
}
