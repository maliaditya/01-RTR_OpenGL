...
void display()
{
    if(GUI)
    {
        ...
        ImGui::Begin("Demo Window", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse);
        ...
        // Text in the demo window
        ImGui::Text("This is a custom theme with no padding and larger text size!");

        // Add sliders or other ImGui widgets for more interaction
        ImGui::SliderFloat("Slider Example",&camera.angleCamera, 0.0f, 1.0f);

        // Demo window content
        ImGui::End();

               ImGui::SetNextWindowBgAlpha(0.35f);
        ImGui::Begin("Demo Wingdow", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse);
        ...
        ImGui::End();
               ...
               ImGui::SetNextWindowBgAlpha(0.35f);
        ImGui::Begin("Demo bottom", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse);
        ImVec2 windowSize = ImGui::GetWindowSize();
        sizes.dockedBottom = windowSize.y;
        // Add a button for demonstration
        if (ImGui::Button("Click Me"))
        {
            // Action on button click
        ...
        ImGui::SetNextWindowBgAlpha(0.35f);
        ImGui::Begin("Left", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse);
         windowSize = ImGui::GetWindowSize();
        sizes.dockedLeft = windowSize.x;
        // Add a button for demonstration
        if (ImGui::Button("Click Me"))
        {
            // Action on button click
